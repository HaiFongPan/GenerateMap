	...
	public List<Coord> getXys() {
		for(int i = 0; i < matrix.length;i++)
			for(int j = 0; j < matrix[i].length;j++)
				if(matrix[i][j]==1)
					xys.add(new Coord(((i+offset_x)/10),((j+offset_y))/10));
		return xys;
	}
...
//		Matrix T = new Matrix(7, 6);
//		T.calcMatrix(T.getMatrix(), T.getMatrix_temp(), 0);
//		System.out.println("初始化矩阵:"+"T");
//		T.showMatirx(T.getMatrix());
//		System.out.println("计算1后的临时矩阵:"+"T'");
//		T.showMatirx(T.getMatrix_temp());
//		T.tempTpMatrix();
//		System.out.println("临时矩阵to矩阵:"+"T");
//		T.showMatirx(T.getMatrix());
//		T.calcMatrix(T.getMatrix_temp(), T.getMatrix(), 1);
//		System.out.println("计算0后的矩阵:"+"T");
//		T.showMatirx(T.getMatrix());
	}
